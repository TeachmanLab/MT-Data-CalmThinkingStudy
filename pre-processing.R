...
#---------------------------
# `particpant_data` is a collection of tables without any duplication
...
data_summary = lapply(particpant_data, summary)
...
#---------------------------
ids_with_pna = lapply(particpant_data, get_ids_with_pna)
ids_with_pna
#---------------------------
